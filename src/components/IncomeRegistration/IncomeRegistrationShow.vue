                     ...
                     <div class="col-md-12"> 
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="sale_invoice">
                                     <small class="text-muted"><b>{{ $t('sale_invoice') }}</b></small> :
                                 </label>
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="invoice_amount">
                                     <small class="text-muted"><b>{{ $t('invoice_amount') }}</b></small> :
                                 </label>
                         ...
                         <!-- <div class="row mx-2 mb-4">
                            ...
                            <el-table :data="Detail" border style="width: 100%;">
                                ...
                                <el-table-column :label="$t('purchase_order')" width="370px"> 
                                    <template #default="scope">
                                        <el-input type="text" :placeholder="$t('please_enter')"  v-model="scope.row.purchase_order_name" disabled />
                                    </template>
                                </el-table-column>
