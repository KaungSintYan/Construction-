...
export default {
    name: 'CollectionRegistrationApprover',
    data() {
        return {            
            data: [], 
            FormData: {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/collect_register_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.collection_registration_id= data.collection_registration_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/collect_register_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
