         ...
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <!-- <router-link :to="`/incomeVisa/edit/${scope.row.revenue_contract_visa_id}`"
                            ...
                            <router-link :to="`/incomeVisa/show/${scope.row.revenue_contract_visa_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.revenue_contract_visa_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.revenue_contract_visa_id)">
...
export default {
    ...
    data() {
        return {             
            //searching
            apiName: "/contractmanagement/get_revenue_contract_visa",
            advanced: true,            
            routeName: "/incomeVisa/",
            showIncomeVisa: true,
            //endsearching
            data: [], 
            loading: false,
    ...
    methods:{   
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/contractmanagement/get_rcv_approve_cc',
                params: {
                    visa_id: id,                  
                }   
            });          
