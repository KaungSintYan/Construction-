...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/other_expense_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.other_expense_id= data.other_expense_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/other_expense_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
