    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        ...
        <div class="row mx-2">  
         <el-table :data="data" border show-summary sum-text="su..."  style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="collection_contract" :label="$t('collection_contract')" width="200" sortable />
            <el-table-column prop="payment_date" :label="$t('payment_date')" width="200" sortable />
            <el-table-column prop="payer" :label="$t('payer')" width="200" sortable />
            <el-table-column prop="payment_method_id" :label="$t('payment_method')" width="200" sortable />
            <el-table-column prop="income_category" :label="$t('income_category')" width="200" sortable />          
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/registration_collection/edit/${scope.row.collection_registration_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.collection_registration_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.collection_registration_id)" >
...
export default {
    ...
    data() {
        return {  
            //searching
            apiName: '/financialmanagement/get_collection_registration',
            advanced: true,            
            routeName: "/registration_collection/",
    ...
    methods:{   
        ...
        async getData(){  
            ...
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/get_collection_registration',
                params: {
                       id: '',
                       keyword: '',             
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/financialmanagement/get_collect_register_approve_cc',
                params: {
                    collection_registration_id: id,                  
                }   
            });          
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                   list.push(this.selectedData[i].collection_registration_id);     
                }
            } 
