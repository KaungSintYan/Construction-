                ...
                <div class="col-md-12">
                    ...
                    <ProjectName :oldProjectId="oldProjectId"  @projectData="getProjectName($event)"  />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input type="text" class="" :placeholder="$t('please_enter')"
...
export default {
    name: 'CollectionRegistrationEdit',
    data() {
        return {
            loading: true,
            FormData: {
         ...
         this.FormData.approver= []; 
            ...
            if(response.status == 200){              
              //console.log(response.data.revenue_contract_id);
                ...
                formData.append('collection_registration_id',id);               
                ...
                if(imgResponse.status == 200){                   
                    toast.success("CollectionRegistration Update successful !", {
