    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row mx-2">  
            <el-table :data="data" border style="width: 100%">
                ...
                <el-table-column prop="invoice_number" :label="$t('invoice_source')" width="230" sortable />
...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/input_invoice_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.input_invoice_id= data.input_invoice_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/input_invoice_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
