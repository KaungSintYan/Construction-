...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api=  '/costmanagement/repayment_note_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.repayment_note_id= data.repayment_note_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/costmanagement/repayment_note_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
