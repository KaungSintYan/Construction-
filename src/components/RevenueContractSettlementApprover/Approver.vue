    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">      
        ...
        <div class="row mx-2">   
            <el-table :data="data" border style="width: 100%">
                ...
                <el-table-column prop="revenue_contract_id" :label="$t('contract_statement_name')" width="220" sortable />
                ...
                <el-table-column prop="settlement_content" :label="$t('revenue_contract')" width="200" sortable />
...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/contractmanagement/rc_settlement_approver_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.settlement_id= data.revenue_contract_settlement_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/contractmanagement/rc_settlement_approver_cc',
                params: {
                       id: '',
                       type: 1,
                },
