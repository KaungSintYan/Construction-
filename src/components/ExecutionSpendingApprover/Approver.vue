...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/contractmanagement/sp_execution_approver_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.execution_id= data.spending_contract_execution_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/contractmanagement/sp_execution_approver_cc',
                params: {
                       id: '',
                       type: 1,
                },
