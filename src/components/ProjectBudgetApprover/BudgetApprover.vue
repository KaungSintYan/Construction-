...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/projectmanagement/project_budget_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.project_budget_id= data.project_budget_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/projectmanagement/project_budget_approve_cc',
                params: {                       
                       type: 1,
                       page: "",
                       limit: "",
