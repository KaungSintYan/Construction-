                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="col-md-3 m-0 p-0">
                            <div class="form-group mb-3">
                                <label for="payment_source">
                                    <small class="text-muted"><b>{{ $t('payment_source') }}</b></small> :
                                </label>
                        ...
                        <label for="purchase_order">
                            <small class="text-muted"><b>{{ $t('purchase_order') }}</b></small> :
                        </label>
                            <el-table :data="FormData.details" border style="width: 100%;">
                                <el-table-column  fixed type="index" width="55" />
                                
                                <el-table-column :label="$t('purchase_order')" width="350px"> 
                                    <template #default="scope">
                                        <el-input type="text" v-model="scope.row.title" :placeholder="$t('please_enter')" disabled  />
                                    </template>
                                </el-table-column>

                                <el-table-column :label="$t('amount')" width="350px"> 
                                    <template #default="scope">
                                        <el-input v-model="scope.row.amount" type="textarea" autosize :placeholder="$t('please_enter')"  maxlength="100" show-word-limit />
                                    </template>
                                </el-table-column>

                                <el-table-column :label="$t('remark')" width="350px"> 
                                    <template #default="scope">
                                        <el-input type="number" :placeholder="$t('please_enter')"  v-model="scope.row.remark" clearable />
                                    </template>
                                </el-table-column>

                                <el-table-column fixed="right" :label="$t('operate')" width="350px">
                        ...
                        <div class="row mx-2 mb-4">
                                    <el-table :data="Detail" border style="width: 100%;">
                                        ...
                                        <el-table-column :label="$t('purchase_requisition')" width="400px"> 
                                            <template #default="scope">
                                                <el-input type="" :placeholder="$t('please_enter')"  v-model="scope.row.purchase_requisition_name" clearable disabled/>
                                            </template>
                                        </el-table-column>
                                        ...
                                        <el-table-column :label="$t('amount')" width="400px"> 
                                            <template #default="scope">
                                                <el-input v-model="scope.row.amount" type="textarea" autosize :placeholder="$t('please_enter')"  maxlength="100" show-word-limit disabled/>
                                            </template>
                                        </el-table-column>
                                        ...
                                        <!-- <el-table-column fixed="right" :label="$t('operate')" width="220px">
                        ...
                        <div class="col-md-3 m-0 p-0">
                            <div class="form-group mb-3">
                                <label for="requested_payment_date">
                                    <small class="text-muted"><b>{{ $t('requested_payment_date') }}</b></small> :
                                </label>
