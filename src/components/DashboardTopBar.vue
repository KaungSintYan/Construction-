                    ...
                    <div class="row mx-2">
                        <div class="col-md-8">
                         <div class="container pt-3">
                            <h2 class=""> Asia Oracle </h2>
                            <!-- <div class="row">
                                            <div class="col-3">
                                                <div class="d-flex">
                                                    <font-awesome-icon icon="fa-solid fa-home" />
                                                    <span class="ml-2 top-subtitle">Workbench</span>
                                                </div>                            
                                            </div>
                                            <div class="col-3">
                                                <div class="d-flex">
                                                    <font-awesome-icon icon="fa-solid fa-wallet" class="mt-1" />
                                                    <span class="ml-2 top-subtitle">Dynamic</span>
                                                </div>                            
                                            </div>
                                            <div class="col-3">
                                                <div class="d-flex">
                                                    <font-awesome-icon icon="fa-solid fa-laptop" class="mt-1" />
                                                    <span class="ml-2 top-subtitle">Smart Kanban</span>
                                                </div>                            
                                            </div>
                                            <div class="col-3">
                                                <div class="d-flex">
                                                    <font-awesome-icon icon="fa-solid fa-user" class="mt-1" />
                                                    <span class="ml-2 top-subtitle"> Control Center </span>
                                                </div>                            
                                            </div>
                            </div> -->
                          </div>                  
                        ...
                        <div class="col-md-4 d-flex justify-content-end">
                            <div class="row"  @click="$store.commit('setActive', !$store.state.active)">
     ...
     <div id="myProfile" v-show="$store.state.active">
            ...
            <div class="col-12">            
                ...
                <!-- <div class="row pt-2">
                    <div class="member-information">
                        <div class="info-text">
                            <img src="../assets/images/logo.svg" width="20" alt="">
                            <span>Expires on 2023-02-14 (remaining: 3 days)</span>
                        </div>  
                        <div class="info-text-one">
                            <span>Used/purchased: 11 people/--people</span>
                        </div>   
                        <span class="buy-service">Buy Service</span>             
                    </div>
                </div> -->
            </div>
        </div>
                    ...
                    <div class="list-group">
                        <div >
                            <a href="#" class="list-group list-group-item-action a-text d-inline-block">
                                <font-awesome-icon icon="fa-solid fa-folder-plus" /><span class="d-inline-block">Create a new business</span></a>
                        </div>
                        
                        <div>
                            <a href="#" class="list-group list-group-item-action a-text d-inline-block" data-toggle="modal" data-target=".change_password">
                                <font-awesome-icon icon="fa-solid fa-lock" /> <span class="d-inline-block">Change Password</span></a>
                        </div>
                        <div>
                            <a class="list-group list-group-item-action a-text d-inline-block"  @click="dialogMobileVisible = true">
                                <font-awesome-icon icon="fa-solid fa-mobile" /><span class="d-inline-block">Modify mobile number</span>
                            </a>
                        </div>                        
                      </div>
            </div>
       ...
       <div class="container basic-info" v-if="basicInfo">
        ...
        <div class="mt-3 mx-2">
            ...
            <div class="row mt-3">
                <div class="col-md-6">Employee No</div>
            ...
            <div class="modal-content" style="width: 900px;">
                ...
                <div class="modal-body p-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" placeholder="Password" v-model="Form.old_password">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="new_password" class="col-sm-3 col-form-label">New Password</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control"  placeholder="Password" v-model="Form.new_password1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="confirm_password" class="col-sm-3 col-form-label">Confirm New Password</label>
                            <div class="col-sm-9">
                                <input type="password" class="form-control" placeholder="Password" v-model="Form.new_password2">
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="width: 700px;">
                 <form @submit.prevent="updateProfile">
                    <div class="modal-header">
                        <div class=""> 
                            <h5 class="text-primary"> <strong>Basic Information Edit Form</strong> </h5>
                        </div>
                    </div>
                    <div class="modal-body p-5">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="width: 500px;">
                ...
                <div class="modal-body m-0 p-0">
                        <h5 class="text-center mt-4"><strong>Thuta</strong></h5>
                        <p class="text-secondary text-center mb-3"><small>CEO</small></p>
                        ...
                        <div clas="file_input_wrap">
                            ...
                            <label for="imageUpload" class="btn btn-large bton-box mt-3 mb-3">Update New Profile</label>
                        </div>

                        <div class="passage-box m-auto">
                            <p>Upload a new avatar. Larger image will be resized automatically. </p><br>
                            <p>Maximum upload size is 1MB.</p>
                        </div>
