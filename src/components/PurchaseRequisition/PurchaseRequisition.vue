<template>  
    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        <div class="row">
            ...
            :showpurchase_requisition="showpurchase_requisition"
        ...
        <div class="row mx-2">   
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="total_amount" :label="$t('total_price')" width="200" sortable />
            <!-- <el-table-column prop="payment_status" :label="$t('payment_status')" width="200" sortable /> -->
            <el-table-column prop="application_date" :label="$t('app_date')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/purchase_requisition/show/${scope.row.purchase_requisition_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/purchase_requisition/edit/${scope.row.purchase_requisition_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.purchase_requisition_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.purchase_requisition_id)">
...
export default {
    ...
    data() {
        return {          
             //searching
            apiName: "/materialmanagement/get_purchase_requisition",
            advanced: true,            
            routeName: "/purchase_requisition/",
            showpurchase_requisition: true,
            //endsearching
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/get_purchasereq_approve_cc',
                params: {
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                   list.push(this.selectedData[i].purchase_requisition_id);   
                }
            } 
