        ...
        <form  @submit.prevent="updateData">      
            <div class="row">
                <div class="col-md-12">  
                    ...
                    <hr>
                    <ProjectName :titleHeader="titleHeader" :oldProjectId="oldProjectId" @projectData="getProjectName($event)"  />
                            ...
                            <div class="form-group mb-3">
                                ...
                                id="complilation_date" style="width: 100%;"  v-model="FormData.application_date" clearable/>
                            </div>
                            <div class="form-group mb-3">
                                <label for="">
                            ...
                            <div class="row mx-2 mb-4">                               
                                <el-table :data="detail" border style="width: 100%;">
                                    ...
                                    <el-table-column :label="$t('material_name')" width="200px"> 
                                    ...
                                    <el-table-column :label="$t('specification')" width="200px"> 
                                        <template #default="scope">
                                            <el-input type="text" :placeholder="$t('please_enter')" class="" 
                                            v-model="scope.row.material_specification" disabled /> 
                                        </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column :label="$t('date')" width="200px"> 
                                        <template #default="scope">
                                            <el-date-picker type="date" class="" 
                                            :placeholder="$t('pick_a_day')" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                                            v-model="scope.row.expected_deli_date" style="width: 100%;" clearable/> 
                                        </template>
                                    </el-table-column>

                                    <el-table-column :label="$t('num_of_plants')" width="200px"> 
                                        <template #default="scope">
       ...
       addMaterial() { 
        ...
        async updateData(e){   
            ...
            if(response.status == 200){ 
                ...
                formData.append('purchase_requisition_id',id);
                ...
                if(imgResponse.status == 200){
                            this.FormPlanDetail.requisition_id= this.$route.params.id;
                            this.detail.forEach((value)=>{
                            if(value.material_detail_id == null){
                                let newdata={
                                    quantity: value.quantity,                                   
                                    remark: value.remark,
                                    expected_deli_date: value.expected_deli_date,
                            ...
                            if(detailResponse.status == 200){                           
                                toast.success("Purchase Requisition Update successful !", {
