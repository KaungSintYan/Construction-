...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/materialmanagement/purchase_requisition_appcc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.purchase_requisition_id= data.purchase_requisition_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/materialmanagement/purchase_requisition_appcc',
                params: {
                       id: '',
                       type: 1,
                },
