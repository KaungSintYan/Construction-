...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api=  '/costmanagement/reimbursement_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.reimbursement_id= data.reimbursement_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/costmanagement/reimbursement_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
