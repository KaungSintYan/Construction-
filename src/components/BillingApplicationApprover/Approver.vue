...
export default {
    name: 'BillingApplicationApprover',
    data() {
        return { 
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/billing_application_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.billing_application_id= data.billing_application_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/billing_application_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
