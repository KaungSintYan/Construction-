                ...
                <div class="col-md-12">                     
                    ...
                    <hr> 
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-select v-model="FormData.distributed_type" class="" :placeholder="$t('please_choose')"  style="width: 100%">
                                    <el-option
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-select v-model="FormData.issue_type" class="" :placeholder="$t('please_choose')"  style="width: 100%">
                                    <el-option
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <el-date-picker v-model="FormData.issueyear"  id="issue_month" type="year" 
                                        format="YYYY" value-format="YYYY"
                                        placeholder="Pick a Year" size="default"  style="width: 100%;" editable clearable />                               
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        placeholder="Pick a Month" size="default"  style="width: 100%;" editable clearable />                               
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input type="button" id="release" class=" text-primary" :model-value="$t('add_release_details')" data-toggle="modal" data-target="#release_details" />
    ...
    methods: {        
        ...
        async getData(){         
            ...
            if(response.message){            
                ...
                this.FormData.issueyear= this.FormData.issueyear.toString();       
                this.FormData.issuemonth= this.FormData.issuemonth.toString();                          
                this.loading = false;
         ...
         this.FormData.approver= []; 
            ...
            if(response.status == 200){              
              ...
              const id = this.$route.params.id;
                ...
                formData.append('salary_payment_id',id);
                ...
                if(imgResponse.status == 200){                   
                    toast.success("Salary Payment Update successful !", {
