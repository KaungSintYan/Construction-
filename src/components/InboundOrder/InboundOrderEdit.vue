                ...
                <div class="col-md-12">
                    ...
                    <ProjectName :oldProjectId="oldProjectId" @projectData="getProjectName($event)"  />  
                            ...
                            <div class="form-group mb-3">
                                ...
                                id="application_date" style="width: 100%;"  v-model="FormData.application_date" clearable/>
                            </div>
                            <PurchaseOrder :projectId="oldProjectId" :oldOrderId="oldOrderId" @orderData="getOrderName($event)" />
                            ...
                            <!-- <div class="form-group mb-3">
                                <label for=""><small><b> {{ $t('warehouse_auto') }} </b></small></label> <br>                            
                                <div class="ml-1">
                                    <el-switch size="large" v-model="FormData.enter_warehouse" active-text="" checked data-toggle="toggle" />
                                </div>
                            </div> -->
...
import PurchaseOrder from '@/components/Share/PurchaseOrder.vue';
...
export default {
    ...
    methods: {
      ...
      handleCurrentChange(val){
        ...
        // },
        getOrderName(data) {
            this.FormData.purchase_order_id= data;
        },
       ...
       addMaterial() { 
        this.selectedMaterial.forEach((val, index)=>{
           ...
           // console.log('addmaterial' + JSON.stringify(this.planDetail));
        ...
        async getData(){ 
            ...
            if(response.status == 200){            
                ...
                this.oldOrderId= this.FormData.purchase_order_id;
                // this.oldPickerId = this.FormData.picker;  
                this.oldSupplierId= this.FormData.supplier;             
                this.oldPurchaseRequisitoinId = this.FormData.purchase_requisition_id;
                ...
                console.log('picker'+ this.oldPickerId);
            }          
        },
        async getPlanDetail(){
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/inbound_order_materialdetail',
                params: {
                    inbound_order_id: this.$route.params.id,                       
                }   
            });
            if(response.status == 200){ 
       ...
       async updateData(e){   
        this.submitting = true;
            ...
            if(response.status == 200){ 
                ...
                formData.append('inbound_order_id',id);
                ...
                method: 'PUT',
                api:  '/materialmanagement/inbound_order_datafiles',    
                data: formData
                });
                if(imgResponse.status == 200){
                            ...
                            if(detailResponse.status == 200){                           
                                toast.success("InboundOrder Update successful !", {
