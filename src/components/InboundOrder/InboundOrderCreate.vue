                ...
                <div class="col-md-12">
                    ...
                    <hr>  
                            ...
                            <div class="form-group mb-3 mt-3">
                                ...
                                <el-input type="text" class="" id="title" :placeholder="$t('please_enter')" v-model="FormData.order.title" clearable/>
                            ...
                            <PurchaseOrder :projectId="FormData.order.project_id" @orderData="getOrderName($event)" />
                            <span v-if="v$.FormData.order.purchase_order_id.$error" class="text-danger">
                                <span v-if="v$.FormData.order.purchase_order_id.$errors[0].$message != ''" >
                                    {{ $t('is_required', {'name': $t('purchase_order')}) }} 
                                </span>                                                                                         
                            </span> 
                            ...
                            <!-- <div class="form-group mb-3">
                                ...
                                <div class="ml-1">
                                    <el-switch size="large" v-model="FormData.order.enter_warehouse" active-text="" inactive-text=""/>
                                </div>
                            </div> -->
...
export default {
    ...
    methods: {
        ...
        // }, 
        getOrderName(data) {
            this.FormData.order.purchase_order_id= data;
        },
       ...
       addMaterial() { 
        ...
        async createData(e){   
            ...
            if(response.status == 201){ 
                const id = response.data.inbound_order_id; 
                const imgformData = new FormData();
                imgformData.append('inbound_order_id',id);
                ...
                if(imgResponse.status == 200){                    
                    toast.success("InboundOrder Insert successful !", {
