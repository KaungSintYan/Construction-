                ...
                <el-card class="box-card" style="width: 100%">                     
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="form-group">
                                <label for="application_date"> 
                                   <small class="text-muted"><b>{{ $t('storage_date') }}</b></small>       
                                </label>
                            ...
                            <!-- <div class="form-group">
                                <label for=""><small class="text-muted"><b> {{ $t('warehouse_auto') }} </b></small></label>                    
                               {{ FormData.enter_warehouse }}
                            </div> -->
                    ...
                    <div class="row mx-2">
                               ...
                               <el-table :data="planDetail" border style="width: 100%;">
                                    ...
                                    <el-table-column :label="$t('material_name')" width="400px"> 
                                        <template #default="scope">
                                           <span>{{scope.row.material_id}}</span>
                                        </template>
                                    </el-table-column>
                                    <el-table-column :label="$t('num_of_plants')" width="400px"> 
                                        <template #default="scope">
