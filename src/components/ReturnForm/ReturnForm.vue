           ...
           <el-table-column  fixed type="selection" width="55" />          
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/return_form/show/${scope.row.return_form_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/return_form/edit/${scope.row.return_form_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.return_form_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.return_form_id)">
...
export default {
    ...
    data() {
        return { 
              ...
              //searching
            apiName: "/materialmanagement/get_return_order",
            advanced: true,            
            routeName: "/return_form/",
            showReturnForm: true,
            //endsearching
//
            data: [], 
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/get_returnorder_approve_cc',
                params: {
                    return_form_id: id,                  
                }   
            });          
         ...
         async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                    list.push(this.selectedData[i].return_form_id);   
                }
            } 
