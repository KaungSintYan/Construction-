    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        ...
        <div class="row mx-2">    
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="payment_terms" :label="$t('payment_terms')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/spending/show/${scope.row.spending_contract_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/spending/edit/${scope.row.spending_contract_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.spending_contract_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.spending_contract_id)">
...
export default {
    ...
    data() {
        return {     
            ...
            //searching
            apiName: "/contractmanagement/get_spending_contract",
            advanced: true,            
            routeName: "/spending/",
            showSpending: true,
            //endsearching
    ...
    methods:{  
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/contractmanagement/get_sp_approve_cc',
                params: {
                    contract_id: id,                  
                }   
            });          
