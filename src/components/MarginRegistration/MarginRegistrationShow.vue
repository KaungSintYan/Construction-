                     ...
                     <div class="col-md-12"> 
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="margin">
                                     <small class="text-muted"><b>{{ $t('margin') }}</b></small> :
                                 </label>
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="party_b">
                                     <small class="text-muted"><b>{{ $t('party_b') }}</b></small> :
                                 </label>
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="client">
                                     <small class="text-muted"><b>{{ $t('client') }}</b></small> :
                                 </label>
                                {{ FormData.client_id }}
                             </div>
                         </div>
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="margin_amt">
                                     <small class="text-muted"><b>{{ $t('margin_amt') }}</b></small> :
                                 </label>
                         ...
                         <div class="col-md-3 m-0 p-0">
                             <div class="form-group mb-3">
                                 <label for="estimated_date_of_return">
                                     <small class="text-muted"><b>{{ $t('estimated_date_of_return') }}</b></small> :
                                 </label>
                                {{ FormData.estimated_date_of_return }}
                             </div>
                         </div>
