...
export default {
    name: 'CostManagementDebitNoteApprover',
    data() {
        return {             
            data: [],           
            FormData: {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/costmanagement/debit_note_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.debit_note_id= data.debit_note_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/costmanagement/debit_note_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
