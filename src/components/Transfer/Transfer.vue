    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row mx-2">       
           <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="project_from_id" :label="$t('call_out_project')" width="200" sortable />
             <el-table-column prop="project_to_id" :label="$t('import_project')" width="200" sortable />
            ...
            <el-table-column prop="transfer_date" :label="$t('applicat_data')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link  :to="`/transfer/show/${scope.row.transfer_order_id}`"
                                v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/transfer/edit/${scope.row.transfer_order_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.transfer_order_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.transfer_order_id)">
...
export default {
    ...
    data() {
        return {   
            ...
            //searching
             apiName: "/materialmanagement/get_transfer_order",
            advanced: true,            
            routeName: "/transfer/",
            showTransfer: true,
            //endsearching
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/get_transferorder_approve_cc',
                params: {
         ...
         async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                    list.push(this.selectedData[i].transfer_order_id);   
                }
            } 
