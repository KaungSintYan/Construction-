<template>  
    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading">
        <div class="row">
            ...
            <div class="col-md-4 mt-2">
                <div class="" style="float: right;">
                    <router-link to="/quality_inspection/create">
        ...
        <div class="row mt-4" v-for="items of data" :key="items.quality_check_id">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 ">
                        <h4>{{ items.title }}</h4>                       
                        <p class="text-muted"> Order number: {{ items.odd_number }} </p>  
                        <p class="text-muted"> quality inspection </p>  
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="text-muted"> The total amount of work (¥) </p>  
                    </div>
                    <!-- <div class="col-md-6">
                        <h4 class="text-warning">5</h4>     
                        <p class="text-muted"> Total amount of jobs (days) </p>  
                    </div>                              -->
                </div>
                <div class="row">
                    <div class="col-md-6">
    ...
    methods:{    
        async searching(){ 
            if(this.formSearching != ""){
                ...
                method: 'POST',
                api: '/constructionmanagement/get_quality_check',
                params: {
                       id: '',                       
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.data.length; i++){
                    if(this.data[i].isSelected){
                        list.push(this.data[i].quality_check_id);                    
                    }
                }
            } 
            ...
            if(list.length > 0){
                ...
                if(response.message){
                    ...
                    this.data=[];
                    this.getData();
                    toast.success("Quality Inspection Delete successful !", {
