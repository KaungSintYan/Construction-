            ...
            <div class="row">
                <div class="col-md-12">  
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input v-model="FormData.description" maxlength="100" 
                            ...
                            <div class="col-md-4 m-0 p-0">
                                <div class="form-group mb-3">
                                    ...
                                    <span v-if="v$.FormData.check_date.$error" class="text-danger">
                                        <span v-if="v$.FormData.check_date.$errors[0].$message != ''">
                                            {{ $t('is_required',{'name': $t('check_date')}) }}
                                        </span>
                                    </span>
                                </div>
                            </div>  

                            <Picker :titleName="$t('checker')" @pickerData="getPickerName($event)" />
                            <span v-if="v$.FormData.checker.$error" class="text-danger">
                                <span v-if="v$.FormData.checker.$errors[0].$message != ''">
      ...
      methods:{       
         ...
         async createData(e){   
             ...
             let response = await authApi({
                 method: 'POST',
                 api: '/constructionmanagement/quality_check',
                 data: this.FormData 
             });
             if(response.status == 201){     
                const id = response.data.quality_check_id; 
                 let imgformData = new FormData();
                 imgformData.append('quality_check_id',id);
                 ...
                 method: 'POST',
                 api:  '/constructionmanagement/quality_check_datafiles',       
                 data: imgformData
                 });
                 if(imgResponse.status == 200){
                    // e.target.reset();
                     toast.success("Quality Inspection Insert successful !", {
