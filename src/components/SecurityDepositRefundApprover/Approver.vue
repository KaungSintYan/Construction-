...
import $ from 'jquery';
export default {
    name: 'SecurityDepositRefundApprover',
    data() {
        return { 
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/security_deposit_refund_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.security_deposit_refund_id= data.security_deposit_refund_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/security_deposit_refund_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
