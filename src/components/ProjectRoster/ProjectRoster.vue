<template>  
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 d-flex justify-content-start">test final</div>
                    <div class="col-md-6 d-flex justify-content-end"><button class="btn btn-sm btn-primary">solid item</button></div>
                </div>
    ...
    methods:{     
        ...
        async getData(){         
            ...
            if(response.message){            
                ...
                this.data = list.map(v => ({...v, isSelected: false}));                            
                console.log('teamList>>'+ JSON.stringify(this.data))
                this.pageCount = response.data.pagecount;
            }
