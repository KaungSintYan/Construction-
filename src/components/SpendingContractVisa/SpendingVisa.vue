<template>  
    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        <div class="row">
            ...
            :showspendingVisa="showspendingVisa"
        ...
        <div class="row mx-2">   
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="visa_date" :label="$t('visa_date')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/spendingVisa/show/${scope.row.spending_contract_visa_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/spendingVisa/edit/${scope.row.spending_contract_visa_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.spending_contract_visa_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.spending_contract_visa_id)">
...
export default {
    ...
    data() {
        return { 
             //searching
            apiName: "/contractmanagement/get_spending_contract_visa",
            advanced: true,            
            routeName: "/spendingVisa/",
            showspendingVisa: true,
            //endsearching
 //
            data: [], 
            loading: false,
    ...
    methods:{    
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/contractmanagement/get_spv_approve_cc',
                params: {
                    visa_id: id,                  
                }   
            });          
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                  list.push(this.selectedData[i].spending_contract_visa_id);          
                }
            } 
