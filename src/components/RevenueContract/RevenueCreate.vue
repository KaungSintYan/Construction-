           ...
           <form  @submit.prevent="createData"> 
            <div class="row">
                <div class="col-md-12"> 
                           ...
                           <TypeOfContract @ContractData="getContractData($event)"  />
                           <span v-if="v$.FormData.contract_info.contract_type_id.$error" class="text-danger">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input type="text" id="contract_title" class="" 
                                :placeholder="$t('please_enter')" v-model="FormData.contract_info.contract_title" clearable/>
                            ...
                            <div class="col-md-3 m-0 p-0">
                                <div class="form-group mb-3">
                                    ...
                                    <el-date-picker v-model="FormData.contract_info.date_of_signing" id="date_of_signing" type="date"
                                     format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                                    :placeholder="$t('pick_a_day')" size="default"  style="width: 100%;"   />                                   
                                    <span v-if="v$.FormData.contract_info.date_of_signing.$error" class="text-danger">
                                        <span v-if="v$.FormData.contract_info.date_of_signing.$errors[0].$message != ''">
                            ...
                            <span v-if="v$.FormData.contract_info.client_id.$error" class="text-danger">
                                <span v-if="v$.FormData.contract_info.client_id.$errors[0].$message != ''">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    id="start_date" style="width: 100%;" :placeholder="$t('pick_a_day')" v-model="FormData.contract_info.start_date" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                    <label for="end_date"> <small><b>{{ $t('end_date') }}</b></small> </label>
                                    <el-date-picker type="date" class="" format="YYYY-MM-DD" 
                                    value-format="YYYY-MM-DD"  id="end_date" style="width: 100%;" v-model="FormData.contract_info.end_date" :placeholder="$t('pick_a_day')" />
                                    </div>
                                </div>
                            </div>
                               ...
                               <div class="row mx-2 mb-4">
                                    <el-table :data="FormData.plan_details" border style="width: 100%;">
                                        ...
                                        <el-table-column :label="$t('payment_terms')" width="200px"> 
                                            <template #default="scope">
                                                <el-input type="textarea" :placeholder="$t('please_enter')"  v-model="scope.row.payment_terms" maxlength="1024" autosize show-word-limit  /> 
                                            </template>
                                        </el-table-column>

                                        <el-table-column :label="$t('remark')" width="200px"> 
                                            <template #default="scope">
                                                <el-input type="textarea" :placeholder="$t('please_enter')"  v-model="scope.row.remark" maxlength="1024" autosize show-word-limit  /> 
                                            </template>
                                        </el-table-column>
                            ...
                            <div class="form-group mb-3">
                               ...
                               <el-input id="payment_terms" maxlength="3000" :placeholder="$t('please_enter')" v-model="FormData.contract_info.payment_terms" show-word-limit type="textarea" />
                            </div>
                            ...
                            <div class="form-group mb-3">
                               ...
                               <el-input id="remark" maxlength="500" v-model="FormData.contract_info.remark" :placeholder="$t('please_enter')" show-word-limit type="textarea" />
                            </div>
...
export default {
    ...
    computed: {
        ...
        calculateTotalPayment(){
            let total_amount = 0;
            for(let i=0; i< this.FormData.plan_details.length; i++){
                let amount= "";
                amount = this.FormData.plan_details[i].payment_amount * this.FormData.plan_details[i].receipt_ratio;
                total_amount += amount;
            }
            return total_amount;
        }
    ...
    methods:{ 
        ...
        getClientData(data){
            this.FormData.contract_info.client_id = data;
        },   
        ...
        async createData(){ 
            ...
            if(response.status == 201){
                ...
                const id = response.data.revenue_contract_id; 
                ...
                if(imgResponse.status == 200){                    
                    toast.success("Revenue Contract Update successful !", {
