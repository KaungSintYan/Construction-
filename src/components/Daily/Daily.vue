<template>  
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row mt-4" v-for="items of data" :key="items.log_id">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 ">
                        <h4>{{ items.title }}</h4>                       
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                       <p class="text-muted"> {{ items.report_date }} </p>                       
                    </div>
                </div>
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.data.length; i++){
                    if(this.data[i].isSelected){
                        list.push(this.data[i].report_id);                    
                    }
                }
            } 
            ...
            if(list.length > 0){
                ...
                if(response.message){
                    ...
                    this.data=[];
                    this.getData();
                    toast.success("Daily Delete successful !", {
