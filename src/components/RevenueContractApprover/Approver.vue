    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">    
        ...
        <div class="row mx-2">   
            <el-table :data="data" border style="width: 100%">
                ...
                <el-table-column prop="" :label="$t('receipt_status')" width="200" sortable />           
                <el-table-column prop="" :label="$t('revision_status')" width="250" sortable />   
                <el-table-column prop="" :label="$t('contract_version')" width="200" sortable />  
                ...
                <el-table-column prop="" :label="$t('contract_party')" width="200" sortable />
                <el-table-column prop="" :label="$t('party_b')" width="200" sortable />
                ...
                <el-table-column prop="" :label="$t('execution_amount')" width="200" sortable />
                <el-table-column prop="" :label="$t('settlement_amount')" width="200" sortable />  
                ...
                <el-table-column prop="" :label="$t('contract_visa_out_amount')" width="320" sortable />         
...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/contractmanagement/rc_approver_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){        
        this.FormData.contract_id= data.revenue_contract_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/contractmanagement/rc_approver_cc',
                params: {
                       id: '',
                       type: 1,
                },
