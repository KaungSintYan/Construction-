                    ...
                    <ProjectName :oldProjectId="oldProjectId" @projectData="getProjectName($event)"  /> 
                            ...
                            <div class="col-md-3 m-0 p-0">
                                <div class="form-group mb-3">
                                    ...
                                    id="repayment_date" style="width: 100%;"  v-model="FormData.repayment_date" clearable/>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                <label for="ordinary_repayment_amount">
                                    <small><b>{{ $t('ordinary_repayment_amt') }}</b></small>
                                </label>
                                <el-input type="text" class="" id="ordinary_repayment_amount"
                                 :placeholder="$t('please_enter')" v-model="FormData.ordinary_repayment_amount" clearable/>
                            </div>

                            <div class="form-group mb-3">
                                <label for="total_repayment_amount"> <small><b> {{ $t('reimbursement_offset_amt') }} </b></small></label>
                                <el-input type="text" id="total_repayment_amount" class="" 
                                placeholder="Automatically generated by the system, no need to fill in" v-model="FormData.reimbursement_offset_amount" clearable/>
                                <small class="text-secondary ml-2"> {{ $t('capital') }} : </small>
                            </div>
                                ...
                                <!-- <table class="table table-hover mt-3 table_main_box" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" rowspan="1" colspan="1" class="table-box"> {{ $t('total_reimbursement_amt') }}  </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-10" style="position: relative;">
                        <div class="row">
                            <input type="text" autocomplete="off" class="input-inner  m-1" placeholder="please enter" style="width: 400px;">
...
export default {
    ...
    methods: {        
        ...
        for(let i=0; i<this.reimbursement.length; i++){
            let detail= data.find(x=>x.reimbursement_id == this.reimbursement[i].reimbursement_id);          
            if(detail){
                detail.reimbursement_name= this.reimbursement[i].title;
                detail.reimbursement_amount = this.reimbursement[i].total_reimbursement_amount;             
            }
        }
        this.loading = false;       
       },
       async getDetail(){
        ...
        async getData(){         
            ...
            if(response.message){            
                ...
                this.oldPickerId = this.FormData.repayer;                 
       ...
       async updateData(e){
        ...
        this.FormData.approver= []; 
            ...
            if(response.status == 200){   
                ...
                formData.append('repayment_note_id',id);
                ...
                if(imgResponse.status == 200){
                    this.FormDetail.repayment_note_id= this.$route.params.id;
                            this.Detail.forEach((value)=>{
                            if(value.detail_id == null){
                                let newdata={
                                    offset_amount: value.offset_amount,  
                                    repayment_note_id: this.$route.params.id,                        
                                    reimbursement_id: value.reimbursement_id,
                                    }
                            ...
                            if(bankResponse.status == 200){                           
                                toast.success("Repayment Note Update successful !", {
