<template>  
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        <div class="row">
            ...
            :showOutboundOrder="showOutboundOrder"         
        ...
        <div class="row mx-2"> 
           <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="application_date" :label="$t('exit_date')" width="200" sortable />          
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link  :to="`/outbound_order/show/${scope.row.outbound_order_id}`"
                                v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/outbound_order/edit/${scope.row.outbound_order_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.outbound_order_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.outbound_order_id)">
...
export default {
    ...
    data() {
        return {  
             //searching
             apiName: "/materialmanagement/get_outbound_order",
            advanced: true,            
            routeName: "/outbound_order/",
            showOutboundOrder: true,
            //endsearching
             //
            data: [], 
            loading: false,
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/get_outboundorder_approve_cc',
                params: {
         ...
         async deleteAll(id = null){         
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                    list.push(this.selectedData[i].outbound_order_id);        
                }
            } 
