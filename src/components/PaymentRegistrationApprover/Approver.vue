    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row mx-2">  
            <el-table :data="data" border style="width: 100%">
                ...
                <el-table-column prop="payment_amount" :label="$t('payment_amount')" width="200" sortable />
                ...
                <el-table-column prop="" :label="$t('payment_source')" width="200" sortable /> 
...
export default {
    name: 'PaymentRegistrationApprover',
    data() {
        return { 
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/payment_register_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.payment_registeration_id= data.payment_registeration_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/payment_register_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
