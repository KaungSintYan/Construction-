<template>  
 <div v-loading="loading" class="loading__div" v-if="loading"></div>    
    <div class="container-fluid"  @click="$store.commit('setActive', false)"  v-if="!loading">
        <div class="row">
            ...
            <div class="col-md-4 mt-2">
                <div class="" style="float: right;">
                    <router-link to="/quality_rectification_list/create">
        ...
        <div class="row mt-4" v-for="items of data" :key="items.quality_inspection_id">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 ">
                        <h4>{{ items.title }}</h4>                       
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="text-warning">{{ items.rectifier }}</h4>                       
                        <p class="text-muted"> Correction result </p>  
                    </div>
                    <div class="col-md-6">
                        <h4 class="text-warning">{{ items.end_date }}</h4>     
                        <p class="text-muted"> required completion time </p>  
                    </div>                             
                </div>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <span class="icon__ellipsis">
                            ...
                            placement="bottom">  
                            <div class="container" >
                                <router-link :to="`/quality_rectification_list/edit/${items.quality_inspection_id}`">
                                <div class="row mb-2" >                                   
                                    <font-awesome-icon icon="fa-solid fa-pencil" style=" margin-right: 5px !important; padding: 2px !important;color: #7d7d7d;" /> edit  
                                </div>
                                </router-link>   
                                <div class="row" @click="deleteAll(items.quality_inspection_id)" >
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.data.length; i++){
                    if(this.data[i].isSelected){
                        list.push(this.data[i].quality_inspection_id);                    
                    }
                }
            } 
            ...
            if(list.length > 0){
                ...
                if(response.message){
                    ...
                    this.data=[];
                    this.getData();
                    toast.success("Quality EectificationList Delete successful !", {
