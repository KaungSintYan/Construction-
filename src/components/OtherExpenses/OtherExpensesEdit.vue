                    ...
                    <hr>
                            ...
                            <div class="col-md-3 m-0 p-0">
                                <div class="form-group mb-3">
                                    ...
                                    <el-date-picker v-model="FormData.fee_date"  id="fee_date" type="date" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input type="number" id="bank_card_number" v-model="FormData.bank_card_number"
    ...
    methods: {        
       ...
       async getExpenditureCategory(){
        ...
        async getDetail(){            
            let response = await authApi({
                method: 'GET',
                api: '/financialmanagement/other_expense_detail',
                params: {
                    other_expense_id: this.$route.params.id,                      
                }   
            });
        ...
        async updateData(e){   
            ...
            if(response.status == 200){              
                ...
                formData.append('other_expense_id',id);
                ...
                if(imgResponse.status == 200){
                    this.FormDetail.other_expense_id= this.$route.params.id;
                            this.Detail.forEach((value)=>{
                            if(value.detail_id == null){
                                let newdata={
                                    expenditure_amount: value.expenditure_amount,
                                    description: value.description,
                                    invoice_amount: value.invoice_amount,
                                    picture: null,
                                    other_expense_id: this.$route.params.id,
                                    category_of_expenditure: value.category_of_expenditure,                                  
                                    }
                            ...
                            if(bankResponse.status == 200){                           
                                toast.success("Other Expense  Update successful !", {
