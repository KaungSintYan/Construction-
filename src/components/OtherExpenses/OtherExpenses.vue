<template>  
    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        <div class="row">
            <FinancialSearching :api="apiName" :advanced="advanced"  :routeName="routeName" :createBtn="createBtn" :showOtherExpenses="showOtherExpenses"           
        ...
        <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="total_amount" :label="$t('total_spending_amt')" width="280" sortable />
            <el-table-column prop="" :label="$t('beneficiary')" width="200" sortable />
            <el-table-column prop="fee_date" :label="$t('fee_date')" width="200" sortable />
            <el-table-column prop="payment_status" :label="$t('payment_status')" width="200" sortable />
            <el-table-column prop="isoffset" :label="$t('offset_type')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/other_expenses/edit/${scope.row.other_expense_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.other_expense_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.other_expense_id)">
...
export default {
    ...
    data() {
        return {   
            //searching
            apiName: '/financialmanagement/get_other_expense',
            advanced: true,            
            routeName: "/other_expenses/",
    ...
    methods:{  
        ...
        async getData(){     
            ...
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/get_other_expense',
                params: {
                       id: '',
                       keyword: '',             
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/financialmanagement/get_other_expense_approve_cc',
                params: {
                    other_expense_id: id,                  
                }   
            });          
        ...
        async deleteAll(id = null){          
            ...
            if(list.length > 0){
                ...
                if(response.message){
                    ...
                    this.data=[];
                    this.getData();
                    toast.success("Other Expenses Delete successful !", {
