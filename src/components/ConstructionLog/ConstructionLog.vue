<template>  
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        <div class="row">
            ...
            <div class="col-md-4 mt-2">
                <div class="" style="float: right;">
                    <router-link to="/construction_log/create">
        ...
        <div class="row" v-for="items of data" :key="items.log_id">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 ">
                        <h4>{{ items.title }}</h4>                       
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                       <p class="text-muted"> {{ items.construction_date }} </p>                       
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <span class="icon__ellipsis">
                            ...
                            <div class="container" >
                                <div class="row" >
                                    <router-link :to="`/construction_log/edit/${items.log_id}`">
