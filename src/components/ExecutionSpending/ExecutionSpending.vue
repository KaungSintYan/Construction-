   ...
   <div v-loading="loading" class="loading__div" v-if="loading"></div>   
    <div class="container-fluid"  @click="$store.commit('setActive', false)" v-if="!loading"> 
        <div class="row">
            ...
            :showexecutionSpending="showexecutionSpending"
        ...
        <div class="row mx-2">
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="execution_order_name" :label="$t('execution_order_name')" width="200" sortable />
            <el-table-column prop="execution_number" :label="$t('odd_number')" width="200" sortable />
            <el-table-column prop="execution_amount" :label="$t('execution_amount')" width="200" sortable />
            <el-table-column prop="execution_date" :label="$t('execution_date')" width="200" sortable />
            <el-table-column prop="execution_content" :label="$t('execution_content')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <!-- <router-link :to="`/executionSpending/edit/${scope.row.spending_contract_execution_id}`"
                            ...
                            <router-link :to="`/executionSpending/show/${scope.row.spending_contract_execution_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.spending_contract_execution_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.spending_contract_execution_id)">
...
export default {
    ...
    data() {
        return { 
              ...
              //searching
            apiName: "/contractmanagement/get_spending_contract_execution",
            advanced: true,            
            routeName: "/executionSpending/",
            showexecutionSpending: true, 
            //endsearching
//
            data: [], 
            loading: false,
    ...
    methods:{    
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/contractmanagement/get_spe_approve_cc',
                params: {
                    execution_id: id,                  
                }   
            });          
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                     list.push(this.selectedData[i].spending_contract_execution_id);
                }
            } 
