<template>    
      <div class="container-fluid mt-2"  @click="$store.commit('setActive', false)">
                 ...
                 <!-- <div class="row mt-3 pt-5 bg-white ">
                     <div class="col-12 shadow-box-app mb-2 pb-2">
                         ...
                         <div class="row">
                             <img src="../assets/images/all.png" alt="" style="margin-left: 10px;"><span> Apply All </span>
                         </div>
                     </div>                                   
                                                
                 </div>             -->
                 <div class="row mb-3 pb-5 bg-white">
                     <h5 class="ml-2"> Project Statistics </h5>       
                     <div class="col-12">                              
                         <div class="row">
                             <div class="col-3">
                                 <div class="approve-box">
                 ...
                 <div class="row">
                     <div class="col-8 bg-white">                    
                           ...
                           <div class="row mt-2" v-for="(items,i) in approverNoti" :key="items.noti_id"  v-show="i < 2">
                                <div class="col-10 d-flex justify-content-start">
                                    <div class="container">
                                        <div class="row ml-1">
                                            <p>Title: {{ items.remark }}</p>                                                        
                                        </div>
                                        <div class="row ml-3">                                        
                                            <span class="mr-2 text-muted"> <font-awesome-icon icon="fa-solid fa-building-shield" class="font-awesome-icon mr-3" /> {{ items.app_id }}</span>
                                            <span class="mr-2 text-muted"><font-awesome-icon icon="fa-solid fa-calendar" class="font-awesome-icon mr-3" /> {{ items.creation_date }}</span>
                           ...
                           <div class="row mt-2" v-for="(items, i) in ccNoti" :key="items.noti_id" v-show="i < 2">
                                <div class="col-10 d-flex justify-content-start">
                                    <div class="container">
                                        ...
                                        <div class="row ml-3">                                        
                                            <span class="mr-2 text-muted"> <font-awesome-icon icon="fa-solid fa-building-shield" class="font-awesome-icon mr-2" /> {{ items.app_id }}</span>
                                            <span class="mr-2 text-muted"><font-awesome-icon icon="fa-solid fa-calendar" class="font-awesome-icon mr-2" /> {{ items.creation_date }}</span>
                                            <!-- <span class="mr-2 text-muted"><font-awesome-icon icon="fa-solid fa-commenting" class="font-awesome-icon" /> 0</span> -->
                                            <span class="text-muted"><font-awesome-icon icon="fa-solid fa-building-shield" class="font-awesome-icon mr-2" /> {{ items.project_id }}</span>
                                        </div>    
                                    </div>                                                             
                                </div>                        
                                <div class="col-2 d-flex justify-content-end"><font-awesome-icon icon="fa-solid fa-star" class="font-awesome-icon" 
