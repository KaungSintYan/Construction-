<template>
    ...
    <el-dialog v-model="clientClassificationDialog" title="Insert Client Class" width="30%" draggable>    
...
clientClassificationDialog: false,
submitting: false,            
class_name: "",
class_id: "", 
classification: [], 
...
AddModalForm(){           
this.clientClassificationDialog = true;
},
...
this.$emit("ClientData", this.class_name);       
},
async createData(e){ 
...
toast.success("Client Classification insert successful !", {
    position: toast.POSITION.TOP_RIGHT,
    autoClose: 3000,
    });                             
    this.clientClassificationDialog = false;
