<template>
    <div class="container-fluid my-2">
                    ...
                    <div class="" style="float: right;">
                        <div class="row my-1">
                            <div class="d-flex justify-content-end">
                                <el-radio-group v-model="activeTab" class="ml-2 mr-5" @change="getData()">
     ...
     <div class="row mt-2" v-show="showAdvanced">
        ...
        <div class="col-md-4" v-show="showRequisition">
        ...
        <div class="col-md-4 mb-3" v-show="showInboundOrder != true ">
            <div class="row mx-1 pb-2">
                ...
                <span v-show="showRequisition"><small><b>{{ $t('transfer_date') }}</b></small></span>
                <span v-show="!showReturnForm && !showOutboundOrder && !showRequisition"><small><b>{{ $t('complilation_date') }}</b></small></span>            
            </div>
            <div class="row mx-1">    
            <el-date-picker
                                v-model="date"
        ...
        <div class="col-md-4 mb-3" v-show="showInboundOrder || showReturnForm  || showOutboundOrder || showRequisition"> 
    ...
    export default {
        ...
        methods:{           
             ...
             this.project_to_id = data.project_id;        
            },  
            getProjectName(data) {   
            ...
            async searching(){   
                ...
                if(this.showRequisition){
                    if(this.date != "" && this.date != null){
                        let start_min_date= this.convertDate(this.date[0]);
                        let start_max_date = this.convertDate(this.date[1]);
                        this.RequisitionFormData.transfer_date.min_date= start_min_date;
                        this.RequisitionFormData.transfer_date.max_date = start_max_date;
                        }
                        else{
                            this.RequisitionFormData.transfer_date.min_date= "";
                            this.RequisitionFormData.transfer_date.max_date = "";
                        }
                        this.RequisitionFormData.approve_status= this.approve_status;
                        this.RequisitionFormData.project_from_id= this.project_id;    
                        this.RequisitionFormData.project_to_id= this.project_to_id;                          
                        FormData = this.RequisitionFormData;
                }
                if(!this.showpurchase_requisition && !this.showPurchaseOrder && !this.showInboundOrder && !this.showRequisition){
                    if(this.date != "" && this.date != null){
                        let start_min_date= this.convertDate(this.date[0]);
                        let start_max_date = this.convertDate(this.date[1]);
