...
export default {
    ...
    methods:{ 
        async getData(val){            
            let type= "";
            let api= '/financialmanagement/sales_invoice_approve_cc';            
            if(val == "CC"){               
                type = 0;
        ...
        getEdit(data){
        this.FormData.sales_invoice_id= data.sales_invoice_id;
        ...
        async updateData() {
            let response = await authApi({
                method: 'POST',
                api: '/financialmanagement/sales_invoice_approve_cc',
                params: {
                       id: '',
                       type: 1,
                },
