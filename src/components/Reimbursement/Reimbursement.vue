    ...
    <div class="container-fluid"  @click="$store.commit('setActive', false)">
        ...
        <div class="row mx-2">   
         <el-table :data="data" border  show-summary sum-text="su..."  style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="total_reimbursement_amount" :label="$t('total_reimbursement_amount')" width="250" sortable />
            <!-- <el-table-column prop="reimburser" :label="$t('reimburser')" width="200" sortable /> -->
            <el-table-column prop="reimbursement_date" :label="$t('reimbursement_date')" width="250" sortable />
            <el-table-column prop="payment_status" :label="$t('payment_status')" width="200" sortable />
            <el-table-column prop="offset_loan_amount" :label="$t('offset_loan_amount')" width="200" sortable />
            <el-table-column prop="amt_offset_against_reserve_fund" :label="$t('amount_of_offset_against_reserve_fund')" width="400" sortable />     
            <el-table-column prop="total_reimbursement_amount" :label="$t('reimbursement_balance')" width="220" sortable />     
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            ...
                            <router-link  :to="`/reimbursement/show/${scope.row.reimbursement_id}`"
                                v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/reimbursement/edit/${scope.row.reimbursement_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.reimbursement_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.reimbursement_id)">
...
export default {
    ...
    data() {
        return {  
            //searching
            apiName: '/costmanagement/get_reimbursement',
            advanced: true,            
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/costmanagement/get_reimbursement_approve_cc',
                params: {
                    reimbursement_id: id,                  
                }   
            });          
         ...
         async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                    list.push(this.selectedData[i].reimbursement_id);   
                }
            } 
