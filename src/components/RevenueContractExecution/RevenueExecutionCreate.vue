            ...
            <div class="row">
                <div class="col-md-12">            
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-input type="text" id="execution_order_name" class="" :placeholder="$t('please_enter')"
                                 v-model="FormData.execution_order_name" clearable/>
                            ...
                            <div class="col-md-3 m-0 p-0">
                                <div class="form-group mb-3">
                                    ...
                                    <el-date-picker :placeholder="$t('pick_a_day')" type="date" class=""  format="YYYY-MM-DD" value-format="YYYY-MM-DD"
                                     id="execution_date" style="width: 100%;"  v-model="FormData.execution_date" />
                                     <span v-if="v$.FormData.execution_date.$error" class="text-danger">
                                        <span v-if="v$.FormData.execution_date.$errors[0].$message != ''">
                                            {{ $t('is_required', {'name': $t('execution_date')}) }}
                                        </span>
                                     </span>
                                </div>
                            </div>
    ...
    methods: {
        ...
        async createData(e){   
            ...
            if(response.status == 201){
                const id = response.data.revenue_contract_execution_id; 
