         ...
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <!-- <router-link :to="`/revenueExecution/edit/${scope.row.revenue_contract_execution_id}`"
                            ...
                            <router-link :to="`/revenueExecution/show/${scope.row.revenue_contract_execution_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.revenue_contract_execution_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.revenue_contract_execution_id)">
...
export default {
    ...
    data() {
        return {       
            //searching
            apiName: "/contractmanagement/get_revenue_contract_execution",
            advanced: true,            
            routeName: "/revenueExecution/",
            showExecution: true,
            //endsearching
    ...
    methods:{   
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/contractmanagement/get_rce_approve_cc',
                params: {
                    execution_id: id,                  
                }   
            });          
        ...
        async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                     list.push(this.selectedData[i].revenue_contract_execution_id);          
                }
            } 
