                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="form-group mb-3">
                                <label for="contract_statement_name">
                                     <small class="text-muted"><b>{{ $t('contract_statement_name') }}</b></small>:   
                                </label>
                                {{ FormData.contract_statement_name }}
                            </div>

                            <div class="form-group mb-3">
                                <label for="settlement_date">
                                     <small class="text-muted"><b>{{ $t('settlement_date') }}</b></small>: 
                                </label>
                            ...
                            <div class="form-group mb-3">
                                <label for="settlement_amount">
                                    <small class="text-muted"><b>{{ $t('settlement_amount') }}</b></small>: 
                                </label>
                            ...
                            <div class="form-group mb-3">
                                <label for="settlement_content">
                                    <small class="text-muted"><b>{{ $t('settlement_content') }}</b></small>:  
                                </label>
                               {{ FormData.settlement_content }}
                            </div>
...
export default {
    name: 'ExpenditureSettlementShow',
    data() {
        return {
             loading: true,             
             FormData: {},   
