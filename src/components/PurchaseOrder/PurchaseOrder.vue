        ...
        <div class="row mx-2">      
         <el-table :data="data" border style="width: 100%" @selection-change="handleSelectionChange">
           <el-table-column  fixed type="selection" width="55" />          
            ...
            <el-table-column prop="storage_status" :label="$t('storage_status')" width="200" sortable />
            ...
            <template #default="scope">
             <div class="action__btn d-flex">
                            <router-link :to="`/purchase_order/show/${scope.row.purchase_order_id}`"
                            v-show="showBtn">
                                <el-tooltip
                                    class="box-item"
                                    effect="dark"
                            ...
                            <!-- <router-link :to="`/purchase_order/edit/${scope.row.purchase_order_id}`"
                            ...
                            placement="top"
                            >
                            <button class="btn-danger circle__btn" @click="deleteAll(scope.row.purchase_order_id)" v-show="deleteBtn && scope.row.editable">
                            ...
                            placement="top"
                            >
                            <button class="btn-warning circle__btn"  @click="showApprover(scope.row.purchase_order_id)">
...
export default {
    ...
    data() {
        return {   
             //searching
             apiName: "/materialmanagement/get_purchase_order",
            advanced: true,            
 ...
 //
    ...
    methods:{     
        ...
        async showApprover(id){ 
            let response = await authApi({
                method: 'GET',
                api: '/materialmanagement/get_purchaseorder_approve_cc',
                params: {
         ...
         async deleteAll(id = null){          
            ...
            if(id != null && id != ""){
                ...
                for(let i=0; i< this.selectedData.length; i++){
                   list.push(this.selectedData[i].purchase_order_id);    
                }
            } 
