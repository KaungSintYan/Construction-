            ...
            <div class="row">
                <div class="col-md-12">
                           <ProjectName :oldProjectId="oldProjectId" @projectData="getProjectName($event)"  />                            
                            <PurchaseRequisition :projectId="oldProjectId" :oldPurchaseRequisitoinId="oldPurchaseRequisitoinId"
                             @purchaseRequisitoinData="getPurchaseName($event)" /> 
                            <div class="form-group mb-3">
                                <label for="title">
                                   <span class="text-danger">*</span><small><b>{{ $t('title_bd') }}</b></small> 
                                </label>
                                <el-input type="text" id="title" class="" v-model="FormData.title" clearable/>
                            </div>
                           ...
                           <div class="form-group mb-3">
                            ...
                            <div class="row mx-2 mb-4">
                                <el-table :data="planDetail" border style="width: 100%;">
                                    ...
                                    <el-table-column :label="$t('unit')" width="200px"> 
                                        <template #default="scope">
...
export default {
    ...
    methods: {
      ...
      handleCurrentChange(val){
        ...
        // getPickerName(data){
        //     this.FormData.warehouse_clerk = data;   
        // },   
        getPurchaseName(data) {
            this.FormData.purchase_requisition_id= data;
        },
       ...
       addMaterial() { 
        this.selectedMaterial.forEach((val, index)=>{
                    let detail= {  
                        purchase_material_detail_id: null,
                        quantity: "",
                        price_per_unit: "",
                        tax_rate: "",
                        tax: "",
        ...
        async getData(){    
            ...
            if(response.status == 200){            
                ...
                // this.oldPickerId = this.FormData.warehouse_clerk;
                ...
                console.log(this.oldPurchaseRequisitoinId);          
        ...
        this.submitting = true;
            ...
            if(response.status == 200){  
                ...
                if(imgResponse.status == 200){
                            this.FormPlanDetail.purchase_order_id= this.$route.params.id;
                            this.planDetail.forEach((value)=>{
                            if(value.purchase_material_detail_id == null){
                                let newdata={
                            ...
                            if(detailResponse.status == 200){                           
                                toast.success("Purchase Order Update successful !", {
