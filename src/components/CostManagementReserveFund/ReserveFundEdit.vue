                    ...
                    <hr>        
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-date-picker :placeholder="$t('pick_a_day')" type="date" class="" format="YYYY-MM-DD" value-format="YYYY-MM-DD" 
                                 id="pick_up_date" style="width: 100%;"  v-model="FormData.pick_up_date" clearable/>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <el-select class="" v-model="FormData.type">
    ...
    methods: {   
        ...
        async getData(){         
            ...
            if(response.status == 200){            
                ...
                this.oldPickerId= this.FormData.receipient;
        ...
        async updateData(e){   
            ...
            if(response.status == 200){              
              //console.log(response.data.revenue_contract_id);
                ...
                formData.append('reserve_fund_id',id);
                ...
                if(imgResponse.status == 200){                    
                    toast.success("ReserveFund Update successful !", {
